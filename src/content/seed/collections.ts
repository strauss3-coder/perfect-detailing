...
export const galleryItems: GalleryItem[] = [
  { id: "g1", title: "55 kWp warehouse array, Midrand", categorySlug: "solar", status: "published", order: 1, kind: "image", media: { src: "", alt: "Warehouse rooftop solar array after ceramic coating with water beading across the modules", ratio: 4 / 3, motif: "solar-array" }, location: "Midrand", serviceSlug: "solar-panel-ceramic-coating", year: 2026 },
  { id: "g2", title: "Residential rooftop, Fourways", categorySlug: "solar", status: "published", order: 2, kind: "image", media: { src: "", alt: "Sixteen panel residential rooftop array freshly coated", ratio: 4 / 3, motif: "solar-panel" }, location: "Fourways", serviceSlug: "solar-panel-ceramic-coating", year: 2026 },
  { id: "g3", title: "Beading test, coated module", categorySlug: "solar", status: "published", order: 3, kind: "video", media: { src: "", alt: "Close-up of water beading and rolling off a coated solar module", ratio: 9 / 16, motif: "droplet" }, poster: { src: "", alt: "Water beads on coated photovoltaic glass", ratio: 9 / 16, motif: "droplet" }, videoUrl: "", location: "Centurion", serviceSlug: "solar-panel-ceramic-coating", year: 2026 },
  { id: "g4", title: "Three-stage correction, black saloon", categorySlug: "automotive", status: "published", order: 4, kind: "image", media: { src: "", alt: "Black saloon after three stage paint correction under raking studio light", ratio: 3 / 2, motif: "sedan" }, location: "Sandton", serviceSlug: "automotive-detailing", year: 2026 },
  { id: "g5", title: "Interior reset, family SUV", categorySlug: "automotive", status: "published", order: 5, kind: "image", media: { src: "", alt: "SUV interior after hot water extraction and leather conditioning", ratio: 3 / 2, motif: "interior" }, location: "Pretoria East", serviceSlug: "automotive-detailing", year: 2026 },
  { id: "g6", title: "Engine bay detail, six-cylinder", categorySlug: "automotive", status: "published", order: 6, kind: "image", media: { src: "", alt: "Detailed engine bay with satin dressed hoses and plastics", ratio: 3 / 2, motif: "engine-bay" }, location: "Randburg", serviceSlug: "automotive-detailing", year: 2025 },
  { id: "g7", title: "Headlight restoration and re-coat", categorySlug: "automotive", status: "published", order: 7, kind: "image", media: { src: "", alt: "Restored headlight lens with fresh UV coating beside an untreated one", ratio: 3 / 2, motif: "headlight" }, location: "Krugersdorp", serviceSlug: "automotive-detailing", year: 2025 },
  { id: "g8", title: "Five-year coating, coupe", categorySlug: "ceramic", status: "published", order: 8, kind: "image", media: { src: "", alt: "Coupe with multi-layer ceramic coating, water beading tightly on the bonnet", ratio: 3 / 2, motif: "coupe" }, location: "Bryanston", serviceSlug: "ceramic-coating", year: 2026 },
  { id: "g9", title: "Coated glass, rain footage", categorySlug: "ceramic", status: "published", order: 9, kind: "video", media: { src: "", alt: "Rain running off coated windscreen glass at speed", ratio: 16 / 9, motif: "droplet" }, poster: { src: "", alt: "Coated windscreen in rain", ratio: 16 / 9, motif: "droplet" }, videoUrl: "", location: "Johannesburg", serviceSlug: "ceramic-coating", year: 2025 },
  { id: "g10", title: "Wheel faces and calipers coated", categorySlug: "ceramic", status: "published", order: 10, kind: "image", media: { src: "", alt: "Coated alloy wheel face with brake dust releasing under a rinse", ratio: 1, motif: "shield" }, location: "Sandton", serviceSlug: "ceramic-coating", year: 2025 },
  { id: "g11", title: "Single-engine piston, hangar dry wash", categorySlug: "aircraft", status: "published", order: 11, kind: "image", media: { src: "", alt: "Single engine aircraft in a hangar after dry wash and coating", ratio: 3 / 2, motif: "aircraft" }, location: "Lanseria", serviceSlug: "aircraft-detailing", year: 2026 },
  { id: "g12", title: "Leading edge, insect strike removed", categorySlug: "aircraft", status: "published", order: 12, kind: "image", media: { src: "", alt: "Aircraft wing leading edge cleaned of insect strike", ratio: 3 / 2, motif: "aircraft" }, location: "Grand Central", serviceSlug: "aircraft-detailing", year: 2025 },
  { id: "g13", title: "Eighteen-van distribution fleet", categorySlug: "fleet", status: "published", order: 13, kind: "image", media: { src: "", alt: "Row of branded panel vans in a depot after an overnight cycle", ratio: 16 / 9, motif: "fleet" }, location: "Isando", serviceSlug: "fleet-services", year: 2026 },
  { id: "g14", title: "Wrap laminate coating, service bakkies", categorySlug: "fleet", status: "published", order: 14, kind: "image", media: { src: "", alt: "Wrapped service bakkie with coated laminate holding its colour", ratio: 3 / 2, motif: "fleet" }, location: "Boksburg", serviceSlug: "fleet-services", year: 2025 },
];
...
export const testimonials: Testimonial[] = [
  t("tst1", 1, "Riaan van Niekerk", "Facilities Manager", "Waterfall Logistics Park", 5,
    ...
    "solar-panel-ceramic-coating", "Midrand", "2026-04-18", true),
  t("tst2", 2, "Nadia Pillay", "Homeowner", "", 5,
    ...
    "solar-panel-ceramic-coating", "Fourways", "2026-02-09", true),
  t("tst3", 3, "Marius Botha", "Owner", "", 5,
    ...
    "automotive-detailing", "Sandton", "2026-01-27", true),
  t("tst4", 4, "Thandeka Mokoena", "Operations Director", "Rand Distribution", 5,
    ...
    "fleet-services", "Isando", "2026-03-05", true),
  t("tst5", 5, "Dr Philip Naidoo", "Aircraft Owner", "", 5,
    ...
    "aircraft-detailing", "Lanseria", "2025-11-14", true),
  t("tst6", 6, "Kobus Steyn", "Owner", "", 5,
    ...
    "ceramic-coating", "Bryanston", "2025-08-22", false),
  t("tst7", 7, "Lerato Dlamini", "Body Corporate Trustee", "Parkview Estate", 4,
    ...
    "solar-panel-ceramic-coating", "Parkview", "2025-10-30", false),
  t("tst8", 8, "Anton Ferreira", "Sales Manager", "Highveld Motor Group", 5,
    ...
    "ceramic-coating", "Centurion", "2026-05-11", false),
  t("tst9", 9, "Sarah Whitehead", "Homeowner", "", 5,
    ...
    "automotive-detailing", "Pretoria East", "2025-09-03", false),
  t("tst10", 10, "Gerhard Loots", "Plant Manager", "Vaal Agri Processing", 5,
    ...
    "solar-panel-ceramic-coating", "Vereeniging", "2026-06-02", false),
  t("tst11", 11, "Imraan Adams", "Owner", "", 4,
    ...
    "automotive-detailing", "Randburg", "2025-12-08", false),
  t("tst12", 12, "Chris du Plessis", "Chief Pilot", "Grand Central Charter", 5,
    ...
    "aircraft-detailing", "Grand Central", "2026-04-29", false),
];
