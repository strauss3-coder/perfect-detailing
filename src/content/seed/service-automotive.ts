...
export const automotiveService: ServiceDoc = {
  ...
  heroMedia: {
    src: "/work/panamera/polish-side.webp",
    alt: "A black Porsche Panamera Sport Turismo photographed outdoors after a full detail, holding an unbroken reflection along its flank",
    ratio: 16 / 9,
    motif: "coupe",
  },
  heroStats: [
  ...
  sections: [
    {
      ...
      media: {
        ...
        alt: "A black Porsche Panamera under a full covering of snow foam, left to dwell before anything touches the paint",
        ratio: 16 / 9,
        motif: "foam-cannon",
    ...
    },
    {
      ...
      media: {
        ...
        alt: "A gloved hand drawing a clay bar across a lubricated, foamed black panel beside the Porsche crest",
        ratio: 9 / 16,
        motif: "droplet",
    ...
    },
    {
      ...
      motif: "interior",
      media: {
        src: "/work/panamera/cabin-front.webp",
    ...
    },
    {
      ...
      motif: "engine-bay",
      media: {
        src: "/work/sl65/engine-bay-after.webp",
    ...
    },
    {
      ...
      media: {
        ...
        alt: "A cleaned and coated Porsche wheel face and arch, the paint above it holding a clean reflection",
        ratio: 1600 / 1076,
        motif: "shield",
    ...
    },
    {
      ...
      motif: "headlight",
      media: {
        src: "/work/bmw7/after-front.webp",
        alt: "The front of a black BMW 7 Series after detailing, headlamp lenses clear and the paint reflecting cleanly",
        ratio: 16 / 9,
        motif: "headlight",
